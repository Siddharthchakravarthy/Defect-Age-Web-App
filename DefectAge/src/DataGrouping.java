...
public class DataGrouping {
	 public void createSummary() {
		 ...
		 String inputFile = "C:\\Users\\PC-1\\eclipse-workspace\\TEst\\target\\DefectAgeing"+currentDate+".xlsx";
		 ...
		 try (FileInputStream fis = new FileInputStream(inputFile);
	            ...
	            try (FileOutputStream fos = new FileOutputStream(inputFile)) {
	                workbook.write(fos);
	                System.out.println("Filtered data saved successfully to " + inputFile);
	            }
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
